...
public class BellmanFordSP_Dataset {
    ...
    /**
     * Computes the shortest paths tree from {@code s} to every other vertex in
     * the edge-weighted digraph {@code G}.
     * @param G the acyclic digraph
     * @param s the source vertex
     * @throws IllegalArgumentException unless {@code 0 <= s < V}
     */
    public BellmanFordSP_Dataset(EdgeWeightedDigraph G, int s) {
    ...
    /**
     * Returns the length of the shortest path from the source vertex {@code s} to vertex {@code v}.
     * @param  v the destination vertex
     * @return the length of the shortest path from the source vertex {@code s} to vertex {@code v};
    ...
    /**
     * Returns the shortest path from the source {@code s} to vertex {@code v}.
     * @param  v the destination vertex
     * @return the shortest path from the source {@code s} to vertex {@code v}
    ...
    public static void main(String[] args) {
        float x=0, y=0, z=0, a=0, b=0, c=0;
        {
            ...
            In in = new In(input);
            int s = Integer.parseInt(String.valueOf(5));
            ...
            // print shortest paths
                ...
                for (int v = 0; v < G.V(); v++) {
                    if (sp.hasPathTo(v)) {
                        ...
                        x = (float) (x + sp.distTo(v));
                        a++;
                        double f = sp.distTo(v);
                        System.out.print(f);
        ...
        }
        {
            ...
            In in = new In(input);
            int s = Integer.parseInt(String.valueOf(1));
            EdgeWeightedDigraph G = new EdgeWeightedDigraph(in);
        ...
        }
        {
            ...
            // print shortest paths
                ...
                System.out.println("Mean =" + ((x/a)+(y/b)+(z/c))/3);
                float[] arr = {x/a , y/b , z/c};
                sort(arr);
